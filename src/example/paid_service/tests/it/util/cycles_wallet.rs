...
#[derive(CandidType, Deserialize, Debug)]
pub(crate) struct WalletBalanceRet {
    pub(crate) amount: u64,
}
#[derive(CandidType, Deserialize, Debug)]
pub(crate) struct WalletBalance128Ret {
...
pub(crate) type WalletResultCall = std::result::Result<WalletResultCallOk, String>;
#[derive(CandidType, Deserialize, Debug)]
...
pub(crate) type WalletResultCallWithMaxCycles =
    std::result::Result<WalletResultCallWithMaxCyclesOk, String>;
#[derive(CandidType, Deserialize, Debug)]
...
#[derive(CandidType, Deserialize, Debug)]
pub(crate) struct WalletResultCreateOk {
    pub(crate) canister_id: Principal,
}
pub(crate) type WalletResultCreate = std::result::Result<WalletResultCreateOk, String>;
#[derive(CandidType, Deserialize, Debug)]
...
impl Service {
    ...
    pub async fn get_events_128(
        &self,
        arg0: &Option<GetEvents128ArgInner>,
    ) -> Result<(Vec<Event128>,)> {
        ic_cdk::call(self.0, "get_events128", (arg0,)).await
    }
    pub async fn get_managed_canister_events(
        &self,
        arg0: &GetManagedCanisterEventsArg,
    ) -> Result<(Option<Vec<ManagedCanisterEvent>>,)> {
        ic_cdk::call(self.0, "get_managed_canister_events", (arg0,)).await
    }
    pub async fn get_managed_canister_events_128(
        &self,
        arg0: &GetManagedCanisterEvents128Arg,
    ) -> Result<(Option<Vec<ManagedCanisterEvent128>>,)> {
    ...
    pub async fn list_managed_canisters(
        &self,
        arg0: &ListManagedCanistersArg,
    ) -> Result<(Vec<ManagedCanisterInfo>, u32)> {
    ...
    pub async fn set_short_name(
        ...
        arg0: &Principal,
        arg1: &Option<String>,
    ) -> Result<(Option<ManagedCanisterInfo>,)> {
    ...
    pub async fn wallet_call_with_max_cycles(
        &self,
        arg0: &WalletCallWithMaxCyclesArg,
    ) -> Result<(WalletResultCallWithMaxCycles,)> {
        ic_cdk::call(self.0, "wallet_call_with_max_cycles", (arg0,)).await
    }
    pub async fn wallet_create_canister(
        &self,
        arg0: &CreateCanisterArgs,
    ) -> Result<(WalletResultCreate,)> {
        ic_cdk::call(self.0, "wallet_create_canister", (arg0,)).await
    }
    pub async fn wallet_create_canister_128(
        &self,
        arg0: &CreateCanisterArgs128,
    ) -> Result<(WalletResultCreate,)> {
    ...
    pub async fn wallet_create_wallet_128(
        &self,
        arg0: &CreateCanisterArgs128,
    ) -> Result<(WalletResultCreate,)> {
...
impl From<PicCanister> for CyclesWalletPic {
